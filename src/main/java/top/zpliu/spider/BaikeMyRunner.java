...
/*@Component*/
public class BaikeMyRunner implements CommandLineRunner {
    @Override
    ...
    private void getListPage(String url, XSSFWorkbook wb, XSSFSheet se) throws InterruptedException {
        ...
        Elements elements = body.getElementsByClass("typeInfo_Li");
        for (Element element : elements) {
            ...
            List<Detail> details = getDetailPage("https://www.baikemy.com" + title.attr("href"), row);
